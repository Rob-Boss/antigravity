<script lang="ts">
    ...
    // Rainbow Prism Props
    export let numLayers = 12; // Reduced from original high count
    export let layerSpread = 60;
    export let audioVariant = 5;
    export let refractionSpeed = 0.08; // Increased from 0.04
    export let damping = 0.15;
    export let rainbowSpeed = 0.005;
